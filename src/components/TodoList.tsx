...
export function TodoList({ todos, onToggle, onDelete, onReorder, onBreakDown, breakingDownId }: TodoListProps) {
  ...
  return (
    <section className='bg-(--color-app-surface) border border-(--color-app-border) rounded-xl p-5 shadow-lg'>
      <div className='flex items-center justify-between mb-3'>
        <h2 className='text-xs font-semibold uppercase tracking-widest text-(--color-app-text-muted) m-0'>Tasks</h2>
        <span className='text-[13px] text-(--color-app-text-muted)' aria-live='polite'>
